param (
    $resourceBaseName="allagi$( Get-Random -Maximum 1000)",
    $location='eastus'
)
...
dotnet build ..\src\Allagi.Api\Allagi.Api.csproj

Write-Host 'Packaging API project for deployment' -ForegroundColor Green
dotnet publish ..\src\Allagi.Api\Allagi.Api.csproj --self-contained -r win-x86 -o ..\publish
